...
first_names = [
    "Carol", "Jason", "Amy", "Nathan", "Alice",
    "George", "Katherine", "Aaron", "Harold", "Jacob",
    "Rachel", "Madison", "Noah", "Elizabeth", "Michael",
    "Rebecca", "Bryan", "Jeffrey", "Logan", "Ralph",
    "Kevin", "Teresa", "Willie", "Doris", "Raymond",
    "Jacqueline", "Ryan", "Carolyn", "Matthew", "Christian",
    "Alexander", "Frances", "Betty", "Jesse", "Johnny",
    "Charles", "Angela", "Andrew", "Mark", "Joshua",
    "Julia", "Alexis", "Adam", "Ethan", "Kenneth",
    "Diane", "Sean", "Marilyn", "Jordan", "Emma"
]
